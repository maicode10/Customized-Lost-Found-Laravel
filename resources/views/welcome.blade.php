        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    ...
                    <h1 class="mb-1 font-medium">Lost & Found Management System</h1>
                    <p class="mb-2 text-[#706f6c]">Easily report, track, and recover lost items. <br>We suggest starting with the following.</p>
                ...
                {{-- TASK 2: Custom Welcome Image --}}
                <div class="bg-[#fff2f2] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                    <img src="{{ asset('images/welcome-image.png') }}" alt="Welcome" style="width:100%; height:100%; object-fit:cover;">
                </div>
